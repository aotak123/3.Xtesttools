window.skins=window.skins||{};
	...
	function CardTypeItemSkin() {
		_super.call(this);
		this.skinParts = ["titleTxt","descTxt","getBtn","coinImg","btnLabel","imgList","xScroller"];
		
		this.elementsContent = [this.titleTxt_i(),this.descTxt_i(),this.getBtn_i(),this.coinImg_i(),this.btnLabel_i(),this.xScroller_i()];
	}
		...
		this.states = [
			...
			new eui.State ("getOwned",
				[
					...
					new eui.SetProperty("ownSp","y",190)
				])
		];
	}
	...
	_proto.myfriendBtn_i = function () {
		var t = new eui.Image();
		this.myfriendBtn = t;
		t.source = "dispelPk_json.dpk_myfriend";
		t.x = 585;
		t.y = 911;
		return t;
	};
	...
	function PKMenuUISkin() {
		_super.call(this);
		this.skinParts = ["homeBtn","addBtn","helpBtn","itemBtn1","itemBtn2","itemBtn3","itemBtn4","rewardBtn","coinTxt","ticketTxt","cntTxt0","cntTxt1","cntTxt2","cntTxt3","achieve0","achieve1","achieve2","itemTimeTxt","mScroller","toastTxt0","toastTxt1","toastTxt2","toastTxt3","ticketTimeTxt","mainGrp","itemTipGrp","raceBtn2","raceBtn1"];
		
		this.elementsContent = [this.mainGrp_i(),this.itemTipGrp_i(),this.raceBtn2_i(),this.raceBtn1_i()];
	}
	...
	_proto.mainGrp_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this.homeBtn_i(),this._Image2_i(),this._Image3_i(),this._Image4_i(),this.addBtn_i(),this.helpBtn_i(),this._Image5_i(),this._Image6_i(),this._Image7_i(),this.itemBtn1_i(),this.itemBtn2_i(),this.itemBtn3_i(),this.itemBtn4_i(),this._Image8_i(),this._Image9_i(),this._Image10_i(),this._Image11_i(),this._Image12_i(),this._Image13_i(),this._Image14_i(),this._Image15_i(),this._Image16_i(),this.rewardBtn_i(),this._Label1_i(),this.coinTxt_i(),this.ticketTxt_i(),this.cntTxt0_i(),this.cntTxt1_i(),this.cntTxt2_i(),this.cntTxt3_i(),this.achieve0_i(),this.achieve1_i(),this.achieve2_i(),this.itemTimeTxt_i(),this.mScroller_i(),this._Image17_i(),this.toastTxt0_i(),this.toastTxt1_i(),this.toastTxt2_i(),this.toastTxt3_i(),this.ticketTimeTxt_i(),this._Image18_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto._Image5_i = function () {
		var t = new eui.Image();
		t.height = 160;
		t.scale9Grid = new egret.Rectangle(23,61,4,24);
	...
	_proto._Image7_i = function () {
		var t = new eui.Image();
		t.source = "dispelPk_json.dpk_daoju";
		t.touchEnabled = false;
		t.x = 0;
		t.y = 274;
		return t;
	...
	_proto.raceBtn2_i = function () {
		var t = new eui.Image();
		this.raceBtn2 = t;
		t.source = "dispelPk_json.dpk_pwsbtn";
		t.x = 354;
		t.y = 1076;
		return t;
	};
	...
	function PKResultUISkin() {
		_super.call(this);
		this.skinParts = ["headImg1","headImg2","winnerImg","continueBtn","changeBtn","readyImg","homeBtn","maskRect1","maskRect2","rewardLabel","doubleFlag","addFriendBtn","scoreLabel","readyLabel","p1d1Txt","p1d2Txt","p1d3Txt","p1d4Txt","p1ScoreTxt","p2d1Txt","p2d2Txt","p2d3Txt","p2d4Txt","p2ScoreTxt"];
		
		this.elementsContent = [this.headImg1_i(),this.headImg2_i(),this.winnerImg_i(),this.continueBtn_i(),this.changeBtn_i(),this.readyImg_i(),this.homeBtn_i(),this.maskRect1_i(),this.maskRect2_i(),this.rewardLabel_i(),this.doubleFlag_i(),this.addFriendBtn_i(),this.scoreLabel_i(),this.readyLabel_i(),this._Label1_i(),this._Group1_i()];
	}
	...
	function RedBagViewSkin() {
		...
		this.states = [
			...
			new eui.State ("opened",
				[
					new eui.SetProperty("_Image1","source","new_redbag1_png"),
	...
	_proto._Image3_i = function () {
		var t = new eui.Image();
		t.source = "new_redbag_collectbg_png";
		return t;
	};
	_proto._Label4_i = function () {
		var t = new eui.Label();
	...
	function TreeGetDialogSkin() {
		_super.call(this);
		this.skinParts = ["getBtn1","getBtn2","leftTxt"];
		
		this.elementsContent = [this._Image1_i(),this.getBtn1_i(),this.getBtn2_i(),this._Label1_i(),this._Label2_i(),this.leftTxt_i()];
	}
	...
	_proto.getBtn2_i = function () {
		var t = new eui.Image();
		this.getBtn2 = t;
		t.source = "menuover_json.tnormalget";
		t.touchEnabled = true;
		t.x = 51;
		t.y = 119;
		return t;
