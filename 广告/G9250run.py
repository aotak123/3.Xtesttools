...
if __name__ == '__main__':
    ...
    panguan(14012341472)  # 1/25新增
    panguan(14130006143)  # 1/25新增
    panguan(14030001372)  # 1/27新增
    panguan(14040002483)  # 1/27新增
    panguan(14050003594)  # 1/28新增
    panguan(14060004605)  # 1/28新增
