...
if __name__ == '__main__':
    ...
    panguan(14115001780)  # 2/23新增tak
    panguan(14988882699)  # 2/23新增tak
    panguan(14988883508)  # 2/25新增tak
    panguan(14988884417)  # 2/25新增tak
    panguan(14988885326)  # 2/26新增tak
    panguan(14988886235)  # 2/26新增tak
