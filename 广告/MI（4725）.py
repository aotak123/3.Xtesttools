...
if __name__ == '__main__':
    ...
    panguan(17455039213)
    panguan(19458371424)
    panguan(16015383512)  # 4/12新增tak
    panguan(19293946812)  # 4/12新增tak
    panguan(17980467459)  # 4/13新增tak
    panguan(16021343601)  # 4/13新增tak
    panguan(17412349761)  # 4/19新增tak
    panguan(14024038791)  # 4/19新增tak
