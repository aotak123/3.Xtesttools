...
if __name__ == '__main__':
    ...
    panguan(14987654637)  # 3/25新增tak
    panguan(14987655546)  # 3/25新增tak
    panguan(14987656455)  # 3/26新增tak
    panguan(14987657364)  # 3/26新增tak
    panguan(14987658273)  # 3/29新增tak
    panguan(14987659182)  # 3/29新增tak
